...
public final class JacksonUtils {
    ...
    public static <T> T toBean(String jsonStr,JavaType clazz) {
        try {
            return objectMapper.readValue(jsonStr, clazz);
        } catch (IOException e) {
            logger.error("Jackson to Bean error! JsonStr: {}, ClassName: {}",
                    jsonStr, clazz.getRawClass(), e);
        }
        return null;
    }
    /**
    ...
    public static <T> T toBean (String jsonStr, TypeReference<T> typeReference){
        try {
            ...
            logger.error("Jackson to Bean Collection error! JsonStr: {}, typeReference: {},execption:{}",
                    jsonStr, typeReference.toString(),e);
        }
        return null;
    }
    public static JsonNode toTree (String jsonStr){
        try {
            ...
            logger.error("Jackson to Tree Collection error! JsonStr: {}",
                    jsonStr);
        }
        return null;
    }
    public static <T> T toBeanWithSnake (String jsonStr, TypeReference<T> typeReference){
        try {
            return objectMapperWithSnake.readValue(jsonStr, typeReference);
        } catch (IOException e) {
            logger.error("Jackson to Bean Collection error! JsonStr: {}, typeReference: {}",
                    jsonStr, typeReference.toString());
        }
        return null;
    }
